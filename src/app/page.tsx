  ...
  return (
    ...
    <div className="min-h-screen bg-gray-100">
      ...
      <main>
        ...
        {/* About Section */}
        <section id="about" className="py-16 px-4 md:px-8 bg-gradient-to-br from-gray-50 to-blue-50">
  ...
  <div className="max-w-6xl mx-auto relative z-10">
    <div className="grid md:grid-cols-2 gap-12 items-center">
      ...
      <div className="space-y-6">
        ...
        {/* Profile Section */}
        <section id="profile" className="py-16 px-4 md:px-8 bg-gradient-to-br from-blue-50 to-purple-50 overflow-hidden">
          <div className="max-w-6xl mx-auto">
            ...
            <div className="mb-16">
              ...
              <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                ...
                <div className="bg-white p-6 rounded-lg shadow-sm border text-center">
                    <div className="w-12 h-12 mx-auto mb-3">
                      <svg width="256" height="256" viewBox="0 0 256 256" xmlns="http://www.w3.org/2000/svg" className="w-12 h-12">
                        ...
                        <text className="cursor-default" x="75" y="225" fontFamily="Segoe UI, Arial, sans-serif" fontSize="150" fontWeight="bold" fill="#fff">TS</text>
                      </svg>
                  </div>
                  <h4 className="font-semibold text-gray-900 mb-2">
                    TypeScript
                ...
                <div className="bg-white p-6 rounded-lg shadow-sm border text-center">
                    <div className="w-12 h-12 mx-auto mb-3">
                      <svg viewBox="0 0 41 41" xmlns="http://www.w3.org/2000/svg" strokeWidth="1.5">
        ...
        {/* Hire Me Section */}
          <section id="contact-me" className="py-16 px-4 md:px-8 bg-gradient-to-br from-blue-50 via-purple-50 to-pink-50 relative overflow-hidden">
